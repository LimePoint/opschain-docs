...
If you intend to use the OpsChain development environment (used when creating new action definitions) you will need to setup the [CLI dev subcommand dependencies](/advanced/advanced-cli.md#dev-subcommand-dependencies).
