...
Alternatively, <a href='/files/downloads/2026-09-14/values.yaml' download='values.yaml'>download the full `values.yaml`</a> for this version of the documentation, or fetch it directly:
