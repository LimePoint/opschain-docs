...
If you do not have one yet, <a href='/files/downloads/2026-09-14/values.yaml' download='values.yaml'>download the full `values.yaml`</a> for this version of the documentation and configure it as described in the [configuration guides](/setup/configuration/index.md).
:::
