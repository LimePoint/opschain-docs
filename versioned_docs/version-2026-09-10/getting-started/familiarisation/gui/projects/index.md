...
|-------------------------------|----------|
| **Bulk actions**              | When projects are selected, allows you to archive, restore or permanently delete the selected projects.   |
...
To remove a project entirely, you can delete it - either from the project's actions menu, or by selecting one or more projects in the table and choosing _Delete projects_ from the _Bulk actions_ menu.

:::warning
Deleting a project is permanent and irreversible, and removes the project along with everything it owns. A project that has changes recorded against it cannot be deleted - archive it instead. If you only want to hide a project from day-to-day view while keeping its history, [archive](#archiving-a-project) it rather than deleting it.
:::
