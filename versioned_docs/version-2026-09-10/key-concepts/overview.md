...
Assets are the inner-most level of the OpsChain organization structure. They are directly linked to the templates in your Git repository, and should be the closest representation of actual infrastructures or services that you want to manage. They are associated with Git repositories via [templates](/getting-started/familiarisation/gui/projects/asset_templates.md) and linked to a Git revision via [template versions](/getting-started/familiarisation/gui/projects/asset_templates.md#about-asset-template-versions), which makes them the ideal component for running [changes](/key-concepts/changes.md).
...
You can read more about assets in the [assets guide](/getting-started/familiarisation/gui/projects/assets.md).
...
See the [Git remotes guide](/getting-started/familiarisation/gui/projects/git_remotes.md) for more information.
...
See the [asset templates guide](/getting-started/familiarisation/gui/projects/asset_templates.md) for more information.
...
See the [asset template versions guide](/getting-started/familiarisation/gui/projects/asset_templates.md#about-asset-template-versions) for more information.
...
See the [workflows guide](/getting-started/familiarisation/gui/workflows.md) for more information.
...
See the [scheduled activities](/getting-started/familiarisation/gui/scheduled_activities.md) guide for instructions on how to create a scheduled change or a scheduled workflow run.
...
See the [actions reference guide](/key-concepts/actions.md#defining-standalone-actions) for more information.
...
See the [actions reference guide](/key-concepts/actions.md#defining-resource-types--resources) for more information.
...
See the [actions reference guide](/key-concepts/actions.md#defining-composite-resources--resource-types) for more information.

### Controller

A controller is a Ruby object that can be configured via properties and provides the logic for completing different actions. A controller that inherits from `OpsChain::Dsl::BaseController` gets its constructor, the OpsChain keywords inside its methods, and its actions and properties derived from the class itself.

A controller that does not inherit from the base class must have:
...
Example controllers of both kinds are shown in the [actions reference guide](/key-concepts/actions.md#controller).
