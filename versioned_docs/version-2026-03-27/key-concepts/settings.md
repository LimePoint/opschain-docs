...
OpsChain configures a [`hostAlias`](https://kubernetes.io/docs/tasks/network/customize-hosts-file-for-pods/) for the [API hostname](/setup/understanding-opschain-variables.md#envopschain_api_host_name-and-apihostname) in the pod for accessing the OpsChain API ingress from within the pod.
