...
- you have installed:
  - the [OpsChain CLI](/advanced/advanced-cli.md#installation) - including setting up all the [dev dependencies](/advanced/advanced-cli.md#dev-subcommand-dependencies)
...
This guide uses an [existing repository](https://github.com/LimePoint/opschain-getting-started) that already contains some sample content. [Fork](https://docs.github.com/en/get-started/quickstart/fork-a-repo) the [sample repo](https://github.com/LimePoint/opschain-getting-started) on GitHub and use your own fork to allow you to push your changes and use them from your OpsChain project. _When forking the repository, ensure that you fork all branches._
