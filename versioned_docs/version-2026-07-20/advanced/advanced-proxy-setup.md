...
```text
opschain-api,opschain-build-service,opschain-db-rw,opschain-image-registry,opschain-ingress-proxy,opschain-ingress-validation-webhook,opschain-ldap,opschain-log-aggregator,opschain-mintmodel-steps-api
```
...
env:
  ...
  - name: HTTPS_PROXY
    value: "http://cntlm-proxy.default.svc.cluster.local:4125"
  - name: NO_PROXY
    value: "localhost,127.0.0.1,10.42.0.0/16,10.43.0.0/16,.svc.cluster.local,.cluster.local,opschain-api,opschain-build-service,opschain-db-rw,opschain-image-registry,opschain-ingress-proxy,opschain-ingress-validation-webhook,opschain-ldap,opschain-log-aggregator,opschain-mintmodel-steps-api"
  - name: http_proxy
    value: "http://cntlm-proxy.default.svc.cluster.local:4125"
  - name: https_proxy
    value: "http://cntlm-proxy.default.svc.cluster.local:4125"
