...
A sample `step_context.json` file is available to view [here](/files/samples/2026-08-14/step_context.json).

:::warning[Rebuild any custom runner images after upgrading]
