...
Installing OpsChain waits for the operator's webhook to be accepting connections before creating any database resources. If the operator is missing or unhealthy, the installation stops early rather than part way through - see [CNPG webhook not ready during installation or upgrade](/troubleshooting.md#cnpg-webhook-not-ready-during-installation-or-upgrade).
