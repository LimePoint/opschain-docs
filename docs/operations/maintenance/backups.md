...
In the recovery pod shell, verify that the backup files have been copied:
...
In the recovery pod shell, cleanup the PostgreSQL files in the database directory:
